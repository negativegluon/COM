...
from models.MPSA.utils.eval import count_parameters

from models.MPSA.models.backbone.Swin_Transformer import swin_backbone, PatchMerging, Mlp,swin_backbone_tiny
...
class MultiPartsSampling(nn.Module):
	def __init__(self, dim, input_size, backbone=None, parts_ratio=2, num_heads=16,
	            feature_weights_pooling=True, att_drop=0.2, head_drop=0.5,
	             ...
	             label_smooth=0.0, mixup=0.,backbone_type='hier', if_feat = False):
