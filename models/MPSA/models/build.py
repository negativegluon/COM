...
import timm
import torch
from models.MPSA.models.backbone.ResNet import resnet_backbone
from models.MPSA.models.backbone.Swin_Transformer import swin_backbone, swin_backbone_large,swin_backbone_tiny
from models.MPSA.models.backbone.Vision_Transformer import vit_backbone
from models.MPSA.models.mps import MultiPartsSampling


def build_models(config, num_classes, if_feat=False):
	...
	model = MultiPartsSampling(dim, config.data.img_size,
	                           ...
	                           config.model.label_smooth,mixup=config.data.mixup,backbone_type=backbone_type, if_feat=if_feat)
	return model
