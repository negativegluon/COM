...
'''try:
    ...
    has_mmseg = True
    print('successfully imported mmseg')
except ImportError:
...
def get_conv2d(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, bias,
    ...
    #print('use original conv. check unireplknet.get_conv2d')
...
class UniRepLKNet(nn.Module):
    ...
    def init_weights(self):
        ...
        ckpt_path = '/root/lbs/LDB/models/unireplknet_b_in22k_pretrain.pth'
        print('load ckpt at /root/lbs/LDB/models/unireplknet_b_in22k_pretrain.pth')
        print('change it at unireplknet.py, UniRepLKNet.init_weights')
