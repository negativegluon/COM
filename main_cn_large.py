...
class Trainer:
    def __init__(self, args):
        ...
        'convnext_large', num_classes=len(self.label_to_idx)
        ...
        self.model.name = 'ConvNext_L'
        
        checkpoint = torch.load('/root/lbs/LDB/models/convnext_large_22k_224.pth', map_location='cpu')
    ...
    def predict(self):
        ...
        self.model.load_state_dict(torch.load('/root/lbs/LDB/logs/ConvNext_L/02081245/best_model.pth'))
