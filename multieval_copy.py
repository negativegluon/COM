...
from models.MPSA.setup import config as config1
from models.MPSA.models.build import build_models as build_models1

from models.IELT.setup import config as config2
from models.IELT.models.build import build_models as build_models2
...
class Trainer:
    def __init__(self, args):
        ...
        self.model4 = build_models1(config1, 75)
        
        self.model5 = create_model(
        'convnext_large', 
        
        )
        self.model6 = build_models2(config2, 75)
    ...
    def multi_predict(self):
        ...
        self.model1.load_state_dict(torch.load('/root/lbs/LDB/logs/UniRepLKNet_blend/02152044/best_model.pth'))
        self.model2.load_state_dict(torch.load('/root/lbs/LDB/logs/MetaFormer/02152044/best_model.pth'))
        self.model3.load_state_dict(torch.load('/root/lbs/LDB/logs/baseline/02152044/best_model.pth'))
        
        self.model4.load_state_dict(torch.load('/root/lbs/LDB/logs/MPSA/02152044/best_model.pth'))
        self.model5.load_state_dict(torch.load('/root/lbs/LDB/logs/ConvNext_L/02152044/best_model.pth'))
        ...
        #best_weights = (0.15, 0.25, 0.15, 0.15, 0.30)
        #best_weights = (0.25, 0.15, 0.05, 0.35, 0.20)  0.9652
        best_weights = (0.22, 0.25, 0.07, 0.18, 0.28)
